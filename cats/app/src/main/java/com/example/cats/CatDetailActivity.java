...
public class CatDetailActivity extends AppCompatActivity {
    ...
    public CatDatabase db = new CatDatabase();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Cat cat = db.getCatByCatId(catID);
        ...
        // check for cases where info is not available
        ...
        Button favorites_button = findViewById(R.id.favoriteButton);
        final String cat_id = (String) catID;
        favorites_button.setOnClickListener((new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                db.addToFavorites(cat_id);
            }
